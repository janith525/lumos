...
@section('admin_content')
    <div class="admin-header">
        <div>
            <h2 class="admin-title">Edit Product: {{ $product->name }}</h2>
            <p class="admin-subtitle">Modify product information and manage catalog assets.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.products.update', $product->slug) }}" method="POST">
            ...
            <div class="col-md-8">
                ...
                <div class="section-card">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="price" class="form-control" value="{{ old('price', $product->price) }}" placeholder="LKR X,XXX">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="hidden" name="description" id="product-description" value="{{ old('description', $product->description) }}">
                ...
                <div class="section-card">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="dimensions" class="form-control" value="{{ old('dimensions', $product->dimensions) }}" placeholder="Dimensions">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="material" class="form-control" value="{{ old('material', $product->material) }}" placeholder="Material & finish details">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="safety_standards" class="form-control" value="{{ old('safety_standards', $product->safety_standards) }}" placeholder="Certified standards">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="age_range" class="form-control" value="{{ old('age_range', $product->age_range) }}" placeholder="Suitable age groups">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="text" name="lead_time" class="form-control" value="{{ old('lead_time', $product->lead_time) }}" placeholder="Custom preparation lead time">
                    ...
                    <div id="highlights-list">
                        ...
                        @foreach($highlights as $highlight)
                            <div class="highlight-row">
                                <input type="text" name="highlights[]" class="form-control" value="{{ $highlight }}" placeholder="e.g. Handmade with solid wood">
                ...
                <div class="section-card">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title', $product->meta_title) }}" placeholder="Product name | Lumos Kids Room Designers">
                        @error('meta_title') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Meta Description</label>
                        <textarea name="meta_description" class="form-control" rows="3" placeholder="Short description for search engines (max 155 chars)">{{ old('meta_description', $product->meta_description) }}</textarea>
                    ...
                    <div class="mb-0">
                        ...
                        @if($product->og_image)
                            <div class="mb-2">
                                <img src="{{ $product->ogImageUrl() }}" class="img-fluid rounded" style="max-height: 120px;" />
                            </div>
                        @endif
                        <input type="file" class="filepond-og" name="og_image" accept="image/*">
                        <div class="form-text text-muted">Upload an image for social sharing preview. Leave blank to keep existing or fallback to the product's primary image.</div>
                            ...
                            @foreach($allProducts as $related)
                                <label class="product-checkbox-item">
                                    <input
                                        ...
                                        value="{{ $related->id }}"
                                        {{ in_array($related->id, old('related_products', $selectedRelatedIds)) ? 'checked' : '' }}
                                    >
            ...
            <div class="col-md-4">
                ...
                <div class="section-card">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" id="status" class="form-control" style="background: rgba(255,255,255,0.02); border: 1.5px solid rgba(255, 255, 255, 0.08); color: #ffffff; border-radius: 12px; padding: 14px 18px; font-size: 15px; outline: none; transition: all 0.3s; width: 100%;">
                            <option value="published" {{ old('status', $product->status) === 'published' ? 'selected' : '' }} style="background: #1e2738; color: #ffffff;">Published</option>
                            <option value="draft" {{ old('status', $product->status) === 'draft' ? 'selected' : '' }} style="background: #1e2738; color: #ffffff;">Draft</option>
                        </select>
                    ...
                    <div class="toggle-switch">
                        ...
                        <input type="checkbox" name="show_on_home" id="show_on_home" value="1" {{ old('show_on_home', $product->show_on_home) ? 'checked' : '' }}>
                ...
                <div class="section-card">
                    ...
                    <div class="mb-4">
                        ...
                        @if($product->image)
                            <div class="mb-2">
                                <img src="{{ $product->primaryImageUrl() }}" class="img-fluid rounded" style="max-height: 150px;" />
                            </div>
                        @endif
                                ...
                                <div class="row g-2">
                                    @foreach($product->images as $img)
                                        <div class="col-4 position-relative">
                                            <img src="{{ \App\Models\Product::resolveImageUrl($img) }}" class="img-fluid rounded" />
        ...
        <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-blue py-3 px-4">Update Product</button>
        </div>
    </form>
@endsection
